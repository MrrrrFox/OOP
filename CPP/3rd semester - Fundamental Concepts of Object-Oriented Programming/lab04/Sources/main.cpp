 ...
 * 
 * UWAGA!
 * Można korzystać z funkcji bibliotecznych (strlen, strcpy, strcat)
...
int main ()
{
  ...
  AddStudent(&numberOfStudents, &namesList, &surnamesList, &semesterList, "Brunon", "", "Jankowski", 7);

  std::cout << "Same imiona:\n";
  ...
  deleteStudent(&numberOfStudents, &namesList, &surnamesList, &semesterList, 1);
  std::cout << "\nPo usunięciu studenta o indeksie 1:\n";  
  PrintListContent (numberOfStudents, namesList, surnamesList, semesterList);
